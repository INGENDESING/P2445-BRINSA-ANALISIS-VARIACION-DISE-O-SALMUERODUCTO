...
fluidos = {
    "Salmuera Saturada (26% NaCl)": {
        ...
        "caudal_volumetrico_m3h": 300.0  # m3/h
    },
...
# Parámetros geométricos (HDPE PE100 - 12" NPS)
# Salmuera: SDR 11; Condensado: SDR 13.6
diametro_hdpe_12in_salmuera = {
    "OD": 0.315,    # m
    "ID": 0.25773   # m
}
diametro_hdpe_12in_condensado = {
    "OD": 0.315,    # m
    "ID": 0.26868   # m
}
