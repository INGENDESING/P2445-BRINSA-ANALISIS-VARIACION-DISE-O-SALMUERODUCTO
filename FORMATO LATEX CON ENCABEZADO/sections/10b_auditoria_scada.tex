...
El caudal registrado en el SCADA corresponde a la condición operativa actual del sistema, mientras que el proyecto contempla un máximo futuro de \SI{300.00}{\cubic\meter\per\hour} por línea. La cabeza estática en parada obedece a la relación hidrostática $P = \rho\,g\,\Delta h$, función exclusivamente de la cota y la densidad y, por tanto, independiente del caudal. Tras verificación en el DXF, la presión estática en el fondo del sifón es idéntica en ambas envolventes: \SI{13.59}{bar} para salmuera (referencia = tanque de quiebre a \SI{2658.24}{m.s.n.m.}) y \SI{5.32}{bar} para condensado (referencia provisional = estación de bombeo a \SI{2597}{m.s.n.m.}). El bajo caudal operativo presente no atenúa el sobreesfuerzo de la tubería SDR 13.6 en salmuera (\SI{+7.0}{\percent}); la estática gobierna la selección de SDR y el esquema de aislamiento, en tanto que el flujo máximo gobierna las pérdidas dinámicas y el análisis de golpe de ariete.
...
\begin{table}[htbp]
    \centering
    \caption{Pérdidas dinámicas en el tramo PHD (\SI{452.26}{\meter}, ID \SI{257.73}{\mm} para salmuera y \SI{268.68}{\mm} para condensado) por envolvente de caudal.}
