...
2. La alternativa de optimización técnica e instalación civil más conveniente consiste en la instalación de dos **válvulas de seccionamiento y aislamiento automáticas** en las cámaras de conexión del lanzamiento (Km 16.5) y llegada (Km 16.9) de la PHD. Al activarse el cierre de estas válvulas en paradas del salmueroducto, se confina el sifón de forma aislada, limitando la columna estática al desnivel de la PHD (\SI{15.60}{\meter}). 
