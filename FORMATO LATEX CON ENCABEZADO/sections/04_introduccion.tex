...
1. Una línea de salmuera saturada al \SI{26}{\percent} p/p de \text{NaCl} a una temperatura de \SI{15}{\celsius}, con flujo másico de \SI{300000}{\kilogram\per\hour} y diámetro nominal de \SI{12}{in}.
2. Una línea de condensado de vapor industrial a una temperatura de \SI{20}{\celsius}, con flujo másico de \SI{300000}{\kilogram\per\hour} y diámetro nominal de \SI{12}{in}.
El material base planteado para ambas tuberías es Polietileno de Alta Densidad (HDPE) PE100 SDR 17.
